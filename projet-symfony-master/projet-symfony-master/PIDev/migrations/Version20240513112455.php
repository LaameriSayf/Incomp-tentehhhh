 ...
 */
final class Version20240513112455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, idblog_id INT DEFAULT NULL, idadmin_id INT DEFAULT NULL, contenue VARCHAR(2555) DEFAULT NULL, jaime TINYINT(1) DEFAULT NULL, nejaimepas TINYINT(1) DEFAULT NULL, nblike INT NOT NULL, nbdislike INT NOT NULL, INDEX IDX_67F068BC5E42CF9 (idblog_id), INDEX IDX_67F068BCCEFECA1D (idadmin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dossiermedical (id INT AUTO_INCREMENT NOT NULL, patient_id INT DEFAULT NULL, resultatexamen VARCHAR(255) DEFAULT NULL, antecedentspersonnelles JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', date_creation DATETIME DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_6699B4F06B899279 (patient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE global_user (id INT AUTO_INCREMENT NOT NULL, cin INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, genre TINYINT(1) DEFAULT NULL, datenaissance DATETIME DEFAULT NULL, numtel INT DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, interlock TINYINT(1) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, Role VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8CC4E625ABE530DA (cin), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ordonnance (id INT AUTO_INCREMENT NOT NULL, dossiermedical_id INT DEFAULT NULL, idpatient_id INT DEFAULT NULL, renouvellement DATE NOT NULL, medecamentprescrit VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, dateprescription DATE NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, INDEX IDX_924B326CDAFFF6DA (dossiermedical_id), INDEX IDX_924B326CA6208F43 (idpatient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE patient (id INT NOT NULL, numcarte INT DEFAULT NULL, UNIQUE INDEX UNIQ_1ADAD7EBD68F8608 (numcarte), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BCCEFECA1D FOREIGN KEY (idadmin_id) REFERENCES global_user (id)');
        $this->addSql('ALTER TABLE dislike ADD CONSTRAINT FK_FE3BECAADF0FD358 FOREIGN KEY (userr_id) REFERENCES global_user (id)');
        ...
        $this->addSql('ALTER TABLE `like` ADD CONSTRAINT FK_AC6340B3DF0FD358 FOREIGN KEY (userr_id) REFERENCES global_user (id)');
